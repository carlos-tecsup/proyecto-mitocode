package com.tecsup.microservices.license_command_service.swagger;
...
@Configuration
@OpenAPIDefinition(
        info = @Info(title = "Command Microservice", version = "1.0", description = "API documentation for Command Microservice"),
        servers = {
                @Server(url = "http://localhost:9080/api/txn-license", description = "Cloud Gateway Server")
        }
)
